...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { card_no: @seller.card_no, phone: @seller.phone, tag_name: @seller.tag_name, user_id: @seller.user_id }
    end
  ...
  test "should update seller" do
    patch :update, id: @seller, seller: { card_no: @seller.card_no, phone: @seller.phone, tag_name: @seller.tag_name, user_id: @seller.user_id }
    assert_redirected_to seller_path(assigns(:seller))
  end
