...
ActiveRecord::Schema.define(version: 20151210104115) do
  ...
  add_index "pictures", ["email"], name: "index_pictures_on_email", unique: true
  add_index "pictures", ["event_id"], name: "index_pictures_on_event_id"
  add_index "pictures", ["reset_password_token"], name: "index_pictures_on_reset_password_token", unique: true
